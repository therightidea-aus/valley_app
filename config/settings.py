...
env = environ.Env(
    ...
    SESSION_COOKIE_AGE=(int, 60 * 60 * 24 * 90),
    ...
    SPOTIFY_SERMON_RSS_URL=(str, ""),
    APPLE_PODCAST_ID=(str, "1742486451"),
    SPOTIFY_SERMON_SYNC_MINUTES=(int, 15),
...
SPOTIFY_SERMON_RSS_URL = env("SPOTIFY_SERMON_RSS_URL")
APPLE_PODCAST_ID = env("APPLE_PODCAST_ID")
